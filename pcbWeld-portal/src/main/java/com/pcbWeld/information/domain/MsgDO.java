...
public class MsgDO implements Serializable {
	...
	private Long msgUserUpdateId;

	
	
	public Long getMsgUserUpdateId() {
		return msgUserUpdateId;
	}
	public void setMsgUserUpdateId(Long msgUserUpdateId) {
		this.msgUserUpdateId = msgUserUpdateId;
	}
